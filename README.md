...
# Getting Started
1. `$ git clone https://github.com/LaxmanDonthula/wedding-website.git` - clone this project to your computer
2. `$ cd wedding-invite-website` - go inside the project directory
...
# About Me
Hello, my name is Laxman Donthula.
